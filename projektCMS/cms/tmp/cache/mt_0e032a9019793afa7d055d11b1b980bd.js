...
tinymce.init({
    ...
    cmsms_tiny: cmsms_tiny = {
        schema: 'html5',
        base_url: 'http://localhost/projektCMS/cms/',
        resize: true,
        statusbar: true,
        menubar: true,
        filepicker_title: 'Wyb&oacute;r pliku',
        filepicker_url: 'http://localhost/projektCMS/cms/admin/moduleinterface.php?mact=FilePicker,m1_,filepicker,0&__c=8f8f4bfa71efa63f08a&showtemplate=false&field=',
        filebrowser_title: 'Select a file',
        linker_text: 'Link to CMSMS Page',
        linker_title: 'Create a link to a CMSMS content page',
        linker_image: 'http://localhost/projektCMS/cms/modules/MicroTiny/lib/images/cmsmslink.gif',
        linker_url: 'http://localhost/projektCMS/cms/admin/moduleinterface.php?mact=MicroTiny,m1_,linker,0&__c=8f8f4bfa71efa63f08a&showtemplate=false',
        linker_autocomplete_url: 'http://localhost/projektCMS/cms/admin/moduleinterface.php?mact=MicroTiny,m1_,ajax_getpages,0&__c=8f8f4bfa71efa63f08a&showtemplate=false',
        mailto_text: 'Create a mail link',
        mailto_title: 'Create a mail image',
        mailto_image: 'http://localhost/projektCMS/cms/modules/MicroTiny/lib/images/mailto.gif',
